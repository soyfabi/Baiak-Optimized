local rewardsTable = {
    [20] = {type = "bank", id = {20000, 0}, msg = "[Reward Level]: They were deposited in your bank 20.000 gold coins to reach the level 20!"},
	[30] = {type = "bank", id = {30000, 0}, msg = "[Reward Level]: They were deposited in your bank 30.000 gold coins to reach the level 30!"},
	[50] = {type = "bank", id = {50000, 0}, msg = "[Reward Level]: They were deposited in your bank 50.000 gold coins to reach the level 50!"},
	[80] = {type = "bank", id = {50000, 0}, msg = "[Reward Level]: They were deposited in your bank 50.000 gold coins to reach the level 50!"},
	[100] = {type = "bank", id = {100000, 0}, msg = "[Reward Level]: They were deposited in your bank 100.000 gold coins to reach the level 100!"},
	[150] = {type = "bank", id = {100000, 0}, msg = "[Reward Level]: They were deposited in your bank 100.000 gold coins to reach the level 150!"},
	[200] = {type = "bank", id = {100000, 0}, msg = "[Reward Level]: They were deposited in your bank 100.000 gold coins to reach the level 200!"},
	[250] = {type = "bank", id = {100000, 0}, msg = "[Reward Level]: They were deposited in your bank 100.000 gold coins to reach the level 250!"},
	[300] = {type = "bank", id = {100000, 0}, msg = "[Reward Level]: They were deposited in your bank 100.000 gold coins to reach the level 300!"},
	[350] = {type = "bank", id = {100000, 0}, msg = "[Reward Level]: They were deposited in your bank 100.000 gold coins to reach the level 350!"},
}
...
function rewardLevelEvent.onAdvance(player, skill, oldLevel, newLevel)
    ...
    for level, reward in pairs(rewardsTable) do
        if newLevel >= level and player:getStorageValue(storage) < level then
			...
			player:sendTextMessage(MESSAGE_EVENT_ORANGE, reward.msg)
...
function rewardLevelEvent_2.onAdvance(player, skill, oldLevel, newLevel)
    ...
    local rewards = {
        ...
        [4] = { -- Knight, Elite Knight
            ...
            [50] = {backpackItemId = 2862, rewardItems = {{itemId = 237, count = 50}, {itemId = 236, count = 50}}, rewardText = "For reaching the level 50, you have earned a reward."},
        }
    }

    local vocationId = player:getVocation():getId()
    local isPromoted = vocationId > 4
    if isPromoted then
        vocationId = vocationId - 4
    end
    ...
    if vocationRewards then
        ...
        if rewardData then
            ...
            if playerStorage ~= 1 then
                ...
                player:getPosition():sendMagicEffect(math.random(CONST_ME_FIREWORK_YELLOW, CONST_ME_FIREWORK_BLUE))
                player:setStorageValue(newLevel, 1)
            end
        end
    end
