...
monster.attacks = {
	...
	{name ="stalagmite rune_2", interval = 2000, chance = 15, minDamage = -190, maxDamage = -300, range = 7, length = 6, spread = 3, shootEffect = CONST_ANI_POISON, target = false},
	...
	{name ="stone shower rune_2", interval = 2000, chance = 10, minDamage = -230, maxDamage = -450, range = 7, target = false}
}
