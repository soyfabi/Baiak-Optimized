...
monster.attacks = {
	...
	{name ="explosion rune_2", interval = 2000, chance = 15, minDamage = -50, maxDamage = -170, target = false},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_MANADRAIN, minDamage = -40, maxDamage = -60, range = 7, target = false},
	{name ="stone shower rune_2", interval = 2000, chance = 10, minDamage = -70, maxDamage = -140, range = 7, target = false},
