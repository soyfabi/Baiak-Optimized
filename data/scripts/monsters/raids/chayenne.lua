...
monster.loot = {
	...
	{id = 14682, chance = 100000} -- chayenne's magical key
}
...
monster.defenses = {
	...
	{name ="outfit", interval = 2000, chance = 10, effect = CONST_ME_ENERGYHIT, target = false, duration = 10000, monster = "Devovorga"},
	{name ="outfit", interval = 2000, chance = 10, effect = CONST_ME_ENERGYHIT, target = false, duration = 10000, monster = "Chayenne"}
}
