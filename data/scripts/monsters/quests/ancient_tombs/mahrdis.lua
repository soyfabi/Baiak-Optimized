...
monster.attacks = {
	...
	-- fire
	{name ="condition", condition = {type = CONDITION_FIRE, interval = 2000, chance = 13, minDamage = -50, maxDamage = -500}, length = 8, spread = 3, effect = CONST_ME_EXPLOSIONHIT, target = false}
}
