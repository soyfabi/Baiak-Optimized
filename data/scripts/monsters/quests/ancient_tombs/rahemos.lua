...
monster.attacks = {
	...
	{name ="outfit", interval = 1000, chance = 15, range = 7, effect = CONST_ME_MAGIC_BLUE, target = false, duration = 12000, monster = "pig"}
}
...
monster.defenses = {
	...
	{name ="outfit", interval = 1000, chance = 5, effect = CONST_ME_MAGIC_BLUE, target = false, duration = 4000, monster = "demon"}
}
