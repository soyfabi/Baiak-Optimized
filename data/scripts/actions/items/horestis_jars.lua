	...
	elseif item.actionid == 50010 then
		if(item.itemid == 12511) then
			if(Game.getStorageValue(GlobalStorage.TheMummysCurse) == 4) then
				...
				doRemoveItem(getTileItemById({x = 32941, y = 32754, z = 12}, 1603).uid, 1)
				doRemoveItem(getTileItemById({x = 32942, y = 32754, z = 12}, 1603).uid, 1)
				doRemoveItem(getTileItemById({x = 32943, y = 32754, z = 12}, 1603).uid, 1)
				doRemoveItem(getTileItemById({x = 32944, y = 32754, z = 12}, 1603).uid, 1)
				...
				addEvent(Game.createItem, 20 * 60 * 1000, 1603, {x = 32941, y = 32754, z = 12})
				addEvent(Game.createItem, 20 * 60 * 1000, 1603, {x = 32942, y = 32754, z = 12})
				addEvent(Game.createItem, 20 * 60 * 1000, 1603, {x = 32943, y = 32754, z = 12})
				addEvent(Game.createItem, 20 * 60 * 1000, 1603, {x = 32944, y = 32754, z = 12})
			else
