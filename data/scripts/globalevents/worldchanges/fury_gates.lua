local gates = {
	{ city = "Ab'dendriel", mapName = "abdendriel", pos = "32680, 31721, 7", exitPosition = Position(32680, 31720, 7) },
	{ city = "Ankrahmun", mapName = "ankrahmun", pos = "33267, 32841, 7", exitPosition = Position(33269, 32841, 7) },
	{ city = "Carlin", mapName = "carlin", pos = "32261, 31848, 7", exitPosition = Position(32263, 31848, 7) },
	{ city = "Darashia", mapName = "darashia", pos = "33300, 32371, 7", exitPosition = Position(33304, 32371, 7) },
	{ city = "Edron", mapName = "edron", pos = "33220, 31921, 7", exitPosition = Position(33221, 31923, 7) },
	{ city = "Kazordoon", mapName = "kazordoon", pos = "32573, 31981, 7", exitPosition = Position(32575, 31981, 7) },
	{ city = "Liberty Bay", mapName = "libertybay", pos = "32348, 32695, 7", exitPosition = Position(32348, 32693, 7) },
	{ city = "Port Hope", mapName = "porthope", pos = "32530, 32716, 7", exitPosition = Position(32530, 32712, 7) },
	{ city = "Thais", mapName = "thais", pos = "32266, 32164, 7", exitPosition = Position(32265, 32164, 7) },
	{ city = "Venore", mapName = "venore", pos = "32833, 32083, 7", exitPosition = Position(32834, 32082, 7) },
}
...
function furyGates.onStartup(interval)
	...
	print('>> [fury gates] loaded: ' .. selectedGate.mapName ..', ' .. selectedGate.pos ..'.')
...
function furyGatesTeleports.onStepIn(creature, item, position, fromPosition)
	...
	if item.actionid == 9710 then
		if not player:isPremium() or not player:getVocation():getPromotion() or player:getLevel() < 60 then
