...
playerTalkactionsCommands = "*Player Commands*" .. "\n"
		...
		.. "!trainer or !exittrainer " .. "- To enter the trainers or leave the trainers.\n"
		.. "!autosell " .. "- To add, delete, list, to sell items on the machine.\n"
		...
		.. "!starter or !fonticak " .. "- Receive a totally free exercise.\n"
		.. "!id or !clientid " .. "- Display the id of an object. Example: !clientid Demon helmet.\n"
		.. "!tradeoff " .. "- Place an item for sale.\n"
		.. "!questlist or !quest " .. "- View the list of quests you have completed or not completed.\n"
		.. "!oldwall " .. "- Replace the Magic Wall with the old or new one.\n"
		.. "!boost " .. "- Show your total experience bonus, with double exp, cast, castle, potions amplification\n -> or resilience, etc.\n"
		...
		.. "!sellhouse " .. "- Sell a house with Trade.\n"
