...
{
	switch (code) {
		case LUA_ERROR_PLAYER_NOT_FOUND: return "Jogador n�o encontrado";
		case LUA_ERROR_CREATURE_NOT_FOUND: return "Criatura n�o encontrada";
		case LUA_ERROR_ITEM_NOT_FOUND: return "Item n�o encontrado";
		case LUA_ERROR_THING_NOT_FOUND: return "Coisa n�o encontrada";
		case LUA_ERROR_TILE_NOT_FOUND: return "Piso n�o encontrado";
		case LUA_ERROR_HOUSE_NOT_FOUND: return "Casa n�o encontrada";
		case LUA_ERROR_COMBAT_NOT_FOUND: return "Combate n�o encontrado";
		case LUA_ERROR_CONDITION_NOT_FOUND: return "Condi��o n�o encontrada";
		case LUA_ERROR_AREA_NOT_FOUND: return "�rea n�o encontrada";
		case LUA_ERROR_CONTAINER_NOT_FOUND: return "Recipiente n�o encontrado";
		case LUA_ERROR_VARIANT_NOT_FOUND: return "Variante n�o encontrada";
		case LUA_ERROR_VARIANT_UNKNOWN: return "Tipo de variante desconhecido";
		case LUA_ERROR_SPELL_NOT_FOUND: return "Feiti�o n�o encontrado";
		default: return "C�digo de erro incorreto";
	}
}
...
void LuaScriptInterface::registerFunctions()
{
	...
	registerEnum(ITEM_ATTRIBUTE_IMBUEMENTSLOTS);
  ...
  registerEnum(PlayerFlag_CanMoveAllThings)
	...
	registerMethod("ItemType", "getImbuementSlots", LuaScriptInterface::luaItemTypeGetImbuementSlots);
...
int LuaScriptInterface::luaAddEvent(lua_State* L)
{
	...
	if (parameters < 2) {
		reportErrorFunc("Not enough parameters.");
		pushBoolean(L, false);
		return 1;
	}
...
int LuaScriptInterface::luaItemTypeGetImbuementSlots(lua_State* L)
{
	// itemType:getImbuementSlots()
	const ItemType* itemType = getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua_pushnumber(L, itemType->imbuementslots);
	} else {
		lua_pushnil(L);
	}
	return 1;
