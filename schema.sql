...
CREATE TABLE IF NOT EXISTS `guilds` (
  ...
  `namedeposit` varchar(255) NOT NULL DEFAULT '',
  `namewithdraw` varchar(255) NOT NULL DEFAULT '',
  `amountdeposit` int NOT NULL DEFAULT '0',
  `amountwithdraw` int NOT NULL DEFAULT '0',
